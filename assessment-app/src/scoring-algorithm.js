...
// For use in web build or Node.js
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    scoreAssessment,
    formatResult,
    // Expose internals for testing/calibration
    calculateRawScores,
    normalizeAllScores,
    calculateArchetypeScores,
    assignArchetypes,
    determineOutputModifiers,
    // Config (so calibration scripts can modify)
    ARCHETYPE_WEIGHTS,
    SCALE_RANGES
  };
}
...
// ============================================================
// SAMPLE TEST (uncomment to run with `node leapyear-scoring-algorithm.js`)
// ============================================================

/*
// Simulated "Mackenzie" profile — expected: Builder primary, Organizer secondary
const mackenzieResponses = {
  // ORVIS Leadership (moderate — she's not a frontline leader)
  A1: 4, A2: 3, A3: 2, A4: 2, A5: 3,
  // ORVIS Organization (high — she loves systems)
  A6: 5, A7: 4, A8: 4, A9: 5, A10: 4,
  // ORVIS Altruism (moderate)
  A11: 3, A12: 3, A13: 4, A14: 3, A15: 3,
  // ORVIS Creativity (low-moderate)
  A16: 2, A17: 2, A18: 1, A19: 2, A20: 3,
  // ORVIS Analysis (moderate)
  A21: 3, A22: 3, A23: 2, A24: 3, A25: 2,
  // ORVIS Erudition (low-moderate)
  A26: 3, A27: 2, A28: 3, A29: 2, A30: 2,
  // ORVIS Production (moderate-high — she likes making things)
  A31: 3, A32: 3, A33: 4,
  // CEI-II (moderate — not her primary drive)
  B1: 3, B2: 2, B3: 4, B4: 2, B5: 4, B6: 2, B7: 3, B8: 2, B9: 3, B10: 2,
  // NCS-6 (moderate)
  C1: 3, C2: 4, C3: 4, C4: 4, C5: 3, C6: 3,
  // IPIP Achievement-Striving (very high — she drives hard)
  D1: 5, D2: 5, D3: 5, D4: 1,
  // IPIP Self-Efficacy (high)
  D5: 5, D6: 5, D7: 4, D8: 1,
  // IPIP texture facets
  D9: 3, D10: 3, D11: 4, D12: 3, D13: 3, D14: 3,
  D15: 5, D16: 1, D17: 5, D18: 1, D19: 4, D20: 3,
  D21: 3, D22: 3, D23: 4, D24: 3, D25: 4, D26: 3,
  D27: 3, D28: 3,
  // Dweck (moderate growth mindset)
  E1: 4, E2: 4, E3: 5, E4: 4, E5: 3, E6: 3, E7: 3, E8: 3
};

const result = scoreAssessment(mackenzieResponses);
console.log(formatResult(result));
console.log('\nPairing key:', result.pairingKey);
*/
